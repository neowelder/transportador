...
/**
 * This class defines the structure of the 'alumn' table.
 *
 *
 ...
 */
class AlumnTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.AlumnTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('alumn');
		$this->setPhpName('Alumn');
		$this->setClassname('Alumn');
		...
		$this->addColumn('MAIL', 'Mail', 'VARCHAR', true, 80, null);
