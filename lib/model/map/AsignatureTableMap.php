...
/**
 * This class defines the structure of the 'asignature' table.
 *
 *
 ...
 */
class AsignatureTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.AsignatureTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPhpName('Asignature');
		$this->setClassname('Asignature');
