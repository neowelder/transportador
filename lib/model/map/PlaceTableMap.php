...
class PlaceTableMap extends TableMap {
	...
	{
    $this->addRelation('RouteRelatedByOrigin', 'Route', RelationMap::ONE_TO_MANY, array('id' => 'origin', ), null, null);
    $this->addRelation('RouteRelatedByDestination', 'Route', RelationMap::ONE_TO_MANY, array('id' => 'destination', ), null, null);
	} // buildRelations()
