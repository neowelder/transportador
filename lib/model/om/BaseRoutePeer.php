...
abstract class BaseRoutePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Route';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Origin', 'Destination', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'origin', 'destination', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ORIGIN, self::DESTINATION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'origin', 'destination', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Origin' => 1, 'Destination' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'origin' => 1, 'destination' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ORIGIN => 1, self::DESTINATION => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'origin' => 1, 'destination' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RoutePeer::ORIGIN);
		$criteria->addSelectColumn(RoutePeer::DESTINATION);
	}
	...
	/**
	 * Returns the number of rows matching criteria, joining the related PlaceRelatedByOrigin table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinPlaceRelatedByOrigin(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(RoutePeer::ORIGIN, PlacePeer::ID, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related PlaceRelatedByDestination table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinPlaceRelatedByDestination(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(RoutePeer::DESTINATION, PlacePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Route objects pre-filled with their Place objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPlaceRelatedByOrigin(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		RoutePeer::addSelectColumns($criteria);
		$startcol = (RoutePeer::NUM_COLUMNS - RoutePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Route) to $obj2 (Place)
				$obj2->addRouteRelatedByOrigin($obj1);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPlaceRelatedByDestination(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Route) to $obj2 (Place)
				$obj2->addRouteRelatedByDestination($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		RoutePeer::addSelectColumns($criteria);
		$startcol2 = (RoutePeer::NUM_COLUMNS - RoutePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Route) to the collection in $obj2 (Place)
				$obj2->addRouteRelatedByOrigin($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Route) to the collection in $obj3 (Place)
				$obj3->addRouteRelatedByDestination($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptPlaceRelatedByOrigin(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptPlaceRelatedByDestination(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Route objects pre-filled with all related objects except PlaceRelatedByOrigin.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptPlaceRelatedByOrigin(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Route objects pre-filled with all related objects except PlaceRelatedByDestination.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptPlaceRelatedByDestination(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
