...
/**
 * Base class that represents a row from the 'usertype' table.
 *
 * 
 *
...
abstract class BaseUsertype extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = UsertypePeer::NUM_COLUMNS - UsertypePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseUsertype:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseUsertype:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseUsertype:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseUsertype:save:post') as $callable)
				{
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseUsertype:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseUsertype::%s', $method));
	  }
