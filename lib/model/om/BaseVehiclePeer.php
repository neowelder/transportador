...
abstract class BaseVehiclePeer {
	...
	const MARK_ID = 'vehicle.MARK_ID';

	/** the column name for the VECHICLE_TYPE_ID field */
	const VECHICLE_TYPE_ID = 'vehicle.VECHICLE_TYPE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Image', 'MarkId', 'VechicleTypeId', 'Model', 'Plate', 'Capacity', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'image', 'markId', 'vechicleTypeId', 'model', 'plate', 'capacity', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::IMAGE, self::MARK_ID, self::VECHICLE_TYPE_ID, self::MODEL, self::PLATE, self::CAPACITY, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'image', 'mark_id', 'vechicle_type_id', 'model', 'plate', 'capacity', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Image' => 1, 'MarkId' => 2, 'VechicleTypeId' => 3, 'Model' => 4, 'Plate' => 5, 'Capacity' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'image' => 1, 'markId' => 2, 'vechicleTypeId' => 3, 'model' => 4, 'plate' => 5, 'capacity' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::IMAGE => 1, self::MARK_ID => 2, self::VECHICLE_TYPE_ID => 3, self::MODEL => 4, self::PLATE => 5, self::CAPACITY => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'image' => 1, 'mark_id' => 2, 'vechicle_type_id' => 3, 'model' => 4, 'plate' => 5, 'capacity' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(VehiclePeer::IMAGE);
		$criteria->addSelectColumn(VehiclePeer::MARK_ID);
		$criteria->addSelectColumn(VehiclePeer::VECHICLE_TYPE_ID);
		$criteria->addSelectColumn(VehiclePeer::MODEL);
		$criteria->addSelectColumn(VehiclePeer::PLATE);
		$criteria->addSelectColumn(VehiclePeer::CAPACITY);
	}
	 ...
	 */
	public static function addInstanceToPool(Vehicle $obj, $key = null)
	{
	...
	public static function doCountJoinMark(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VehiclePeer::MARK_ID, MarkPeer::ID, $join_behavior);
	...
	public static function doCountJoinVehicleType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VehiclePeer::VECHICLE_TYPE_ID, VehicleTypePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Vehicle objects pre-filled with their Mark objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinMark(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		VehiclePeer::addSelectColumns($criteria);
		$startcol = (VehiclePeer::NUM_COLUMNS - VehiclePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Vehicle) to $obj2 (Mark)
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				if (!$obj2) {
					...
					$cls = VehicleTypePeer::getOMClass(false);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		VehiclePeer::addSelectColumns($criteria);
		$startcol2 = (VehiclePeer::NUM_COLUMNS - VehiclePeer::NUM_LAZY_LOAD_COLUMNS);

		MarkPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (MarkPeer::NUM_COLUMNS - MarkPeer::NUM_LAZY_LOAD_COLUMNS);

		VehicleTypePeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (VehicleTypePeer::NUM_COLUMNS - VehicleTypePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Vehicle) to the collection in $obj2 (Mark)
				$obj2->addVehicle($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Vehicle) to the collection in $obj3 (VehicleType)
				$obj3->addVehicle($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Vehicle objects pre-filled with all related objects except Mark.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptMark(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		VehicleTypePeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (VehicleTypePeer::NUM_COLUMNS - VehicleTypePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	/**
	 * Selects a collection of Vehicle objects pre-filled with all related objects except VehicleType.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseVehiclePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseVehiclePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseVehiclePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseVehiclePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseVehiclePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseVehiclePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseVehiclePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseVehiclePeer', $values, $con, $ret);
    }
